...
module ROM(Addr, Dout);
    ...
    initial begin
        $readmemh("C:\\Users\\20963\\Desktop\\Grade3\\FPGA\\risc-v-single.txt", rom);
        //$readmemh("C:\\Users\\Miles\\Desktop\\Computer-Organization-Big-Homework\\FPGA\\risc-v-single.txt", rom);    // Read initialization data from a file to fill the read-only memory
    end
